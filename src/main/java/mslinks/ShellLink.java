...
public class ShellLink {
	...
	protected static HashMap<Integer, Class> extraTypes = new HashMap<Integer, Class>() {{
	...
	protected ShellLinkHeader header;
	protected LinkTargetIDList idlist;
	protected LinkInfo info;
	protected String name, relativePath, workingDir, cmdArgs, iconLocation;
	protected HashMap<Integer, Serializable> extra = new HashMap<>();

	protected Path linkFileSource;
	...
	protected ShellLink(ByteReader data) throws ShellLinkException, IOException {
	...
	protected static String resolveEnvVariables(String path) {
